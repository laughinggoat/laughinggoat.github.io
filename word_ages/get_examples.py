...
orwell_ages = get_word_ages(orwell_text)
sedaris_ages = get_word_ages(sedaris_text)

orwell_usable = [usable_age(age) for age in orwell_ages]
sedaris_usable = [usable_age(age) for age in sedaris_ages]

orwell_zip = list(zip(orwell_text.split(' '), orwell_usable, orwell_ages))
sedaris_zip = list(zip(sedaris_text.split(' '), sedaris_usable, sedaris_ages))

master = [orwell_zip, sedaris_zip]
